...
function coll_portfolio($atts, $content = null)
{
    ...
    while ($loop->have_posts()) : $loop->the_post();
        ...
        $output .= '<a class="thumb" href="' . $lproj . '">';
        $output .= '<span class="x-preloader"></span>';
        $output .= '<img src="' . $thumb . '" alt=""/>';
        $output .= '</a>';
        $output .= '<div class="info">';
        $output .= '<a class="thumb" href="' . $lproj . '"><h3 class="title">' . get_the_title(get_the_ID()) . '</h3></a>';
        $output .= '<a class="thumb" href="' . $lproj . '"><span class="text">' . get_the_excerpt() . '</span></a>';
        $output .= '</div>';
        $output .= '</div>';
        $output .= '</article>';
    endwhile;
